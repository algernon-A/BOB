    ...
    internal static class Textures
    {
        ...
        internal static UITextureAtlas PackageSprites
        {
            get
            {
                ...
                {
                    packageSprites = TextureUtils.LoadSpriteAtlas("bob_prop_pack_small");
                }
        ...
        internal static UITextureAtlas SingleBuildingSprites
        {
            get
            {
                ...
                {
                    singleBuildingSprites = TextureUtils.LoadSpriteAtlas("bob_single_building_small");
                }
        ...
        internal static UITextureAtlas AllBuildingSprites
        {
            get
            {
                ...
                {
                    allBuildingSprites = TextureUtils.LoadSpriteAtlas("bob_buildings_small");
                }
        ...
        internal static UITextureAtlas SingleNetworkSprites
        {
            get
            {
                ...
                {
                    singleNetworkSprites = TextureUtils.LoadSpriteAtlas("bob_roads_small");
                }
        ...
        internal static UITextureAtlas AllNetworkSprites
        {
            get
            {
                ...
                {
                    allNetworkSprites = TextureUtils.LoadSpriteAtlas("bob_all_roads_small");
                }
