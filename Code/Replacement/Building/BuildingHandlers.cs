// <copyright file="BuildingHandlers.cs" company="algernon (K. Algernon A. Sheppard)">
...
namespace BOB
{
    ...
    internal static class BuildingHandlers
    {
        ...
        internal static BOBConfig.BuildingReplacement GetReplacement(BuildingInfo buildingInfo, int propIndex, ReplacementPriority priority) => GetHandler(buildingInfo, propIndex)?.GetReplacement(priority);
        ...
        internal static void RemoveReplacement(BOBConfig.BuildingReplacement replacement)
        {
