namespace BOB
{
	...
	internal static class NetHandlers
	{
		...
		internal static BOBNetReplacement GetReplacement(NetInfo.Lane laneInfo, int propIndex, ReplacementPriority priority) => GetHandler(laneInfo, propIndex)?.GetReplacement(priority);
		...
		internal static void RemoveReplacement(BOBNetReplacement replacement)
		{
